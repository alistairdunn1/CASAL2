...
#' The deviates from the classic formulation by pulling out (x!) of the denominator from the right hand product
...
#' @param: est, vector of fitted compositions assumes sum(est) = 1
