...
void TagRecaptureByLength::DoValidate() {
  LOG_WARNING() << "This observation class doesn't have a unit-test!. If you want to use this class check the results with CASAL model first to ensure it is correct";
