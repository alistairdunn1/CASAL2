 ...
 * Default constructor
 */
TimeStepProportionsAtLength::TimeStepProportionsAtLength(shared_ptr<Model> model) : observations::age::ProportionsAtLength(model) {
...
void TimeStepProportionsAtLength::DoValidate() {
  ProportionsAtLength::DoValidate();
