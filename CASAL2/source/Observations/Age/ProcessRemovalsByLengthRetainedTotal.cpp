/**
 * @file ProcessRemovalsByLengthRetainedTotal.cpp
 * @author  S. Datta
 * @version 1.0
 * @date 06/05/2019
 * @section LICENSE
 ...
 * Default constructor
 */
ProcessRemovalsByLengthRetainedTotal::ProcessRemovalsByLengthRetainedTotal(shared_ptr<Model> model) : Observation(model) {
 ...
 * Destructor
 */
ProcessRemovalsByLengthRetainedTotal::~ProcessRemovalsByLengthRetainedTotal() {
  delete obs_table_;
 ...
 */
void ProcessRemovalsByLengthRetainedTotal::DoValidate() {
 ...
 */
void ProcessRemovalsByLengthRetainedTotal::DoBuild() {
 ...
 */
void ProcessRemovalsByLengthRetainedTotal::PreExecute() {
...
/**
 * Execute the ProcessRemovalsByLengthRetainedTotal expected values calculations
 */
 ...
 */
void ProcessRemovalsByLengthRetainedTotal::CalculateScore() {
  /**
