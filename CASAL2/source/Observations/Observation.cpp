 ...
 * @param selectivities The selectivity label for this comparison
 ...
 */
void Observation::SaveComparison(string category, std::set<string> selectivities, unsigned age, Double length, Double expected, double observed, Double process_error,
                                 double error_value, Double adjusted_error, Double delta, Double score) {
  observations::Comparison new_comparison;
  new_comparison.category_       = category;
  new_comparison.selectivities_  = selectivities;
...
void Observation::SaveComparison(string category, unsigned age, Double length, Double expected, double observed, Double process_error, double error_value, Double adjusted_error,
  ...
  SaveComparison(category, {}, age, length, expected, observed, process_error, error_value, adjusted_error, delta, score);
}
 ...
 *
 * @param category The name of the comparison
 * @param selectivity The selectivity label for this comparison
 * @param expected The value generated by the model
 * @param observed The value passed in from the configuration file
 * @param process_error The process error value for this comparison
 * @param error_value The error value for this comparison
 ...
 * @param score The amount of score for this comparison
 */
void Observation::SaveComparison(string category, std::set<string> selectivities, Double expected, double observed, Double process_error, double error_value, Double adjusted_error,
                                 Double delta, Double score) {
  SaveComparison(category, selectivities, 0, 0, expected, observed, process_error, error_value, adjusted_error, delta, score);
}
