 ...
 */
#ifndef PROCESSES_COMMON_MORTALITYCONSTANTRATE_H_
#define PROCESSES_COMMON_MORTALITYCONSTANTRATE_H_
 ...
 * Class Definition
 */
class MortalityConstantRate : public niwa::processes::age::Mortality {
public:
  // Methods
  ...
  bool check_categories_in_methods_for_removal_obs(vector<string> methods, vector<string> category_labels) {
    LOG_CODE_ERROR() << "cannot call check_categories_in_methods_for_removal_obs() from MortalityConstantRate";
    return false;
  };
  bool check_years_in_methods_for_removal_obs(vector<unsigned> years, vector<string> methods) {
    LOG_CODE_ERROR() << "cannot call check_years_in_methods_for_removal_obs() from MortalityConstantRate";
    return false;
  };
  ...
  vector<unsigned> get_fishery_ndx_for_catch_at(vector<string> fishery_labels) {
    LOG_CODE_ERROR() << "cannot call get_fishery_ndx_for_catch_at() from MortalityConstantRate";
    vector<unsigned> null_result = {1};
    return null_result;
  };
  vector<unsigned> get_category_ndx_for_catch_at(vector<string> category_labels) {
    LOG_CODE_ERROR() << "cannot call get_category_ndx_for_catch_at() from MortalityConstantRate";
    vector<unsigned> null_result = {1};
    return null_result;
  };
  vector<unsigned> get_year_ndx_for_catch_at(vector<unsigned> years) {
    LOG_CODE_ERROR() << "cannot call get_year_ndx_for_catch_at() from MortalityConstantRate";
    vector<unsigned> null_result = {1};
    return null_result;
  };
  // accessors
...
#endif /* PROCESSES_COMMON_MORTALITYCONSTANTRATE_H_ */
