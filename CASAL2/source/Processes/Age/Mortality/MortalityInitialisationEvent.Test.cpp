/**
 * @file MortalityInitialisationEvent.Test.cpp
 ...
 * Sample unit test
 */
TEST_F(InternalEmptyModel, Process_MortalityInitialisationEvent) {
 ...
 */
TEST_F(InternalEmptyModel, Process_MortalityInitialisationEvent_Across_Categories) {
  const string morality_process = R"(
    @mortality mortality
    type initialisation_event
