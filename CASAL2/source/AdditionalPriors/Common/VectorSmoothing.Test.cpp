...
public:
  MockVectorSmoothing(shared_ptr<Model> model, bool log_scale, unsigned lower_bound, unsigned upper_bound, unsigned r, double multiplier, vector<double>* parameter) :
      VectorSmoothing(model) {
