...
cat("Maintainer: Casal2 Development Team <casal2@zaita.com>\n",file=filename,append=TRUE)
cat("License: GPL-2\n",file=filename,append=TRUE)
cat("Encoding: UTF-8\n",file=filename,append=TRUE)
cat("URL: https://www.github.com/Casal2\n",file=filename,append=TRUE)
cat("Copyright: New Zealand Ministry for Primary Industries\n",file=filename,append=TRUE)
cat("BugReports: https://github.com/Casal2/CASAL2/issues\n",file=filename,append=TRUE)
cat("Suggests:\n    testthat (>= 3.0.0)\n",file=filename,append=TRUE)
cat("RoxygenNote: 7.3.3\n",file=filename,append=TRUE)
