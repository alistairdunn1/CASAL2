...
#'
#' This function reads in a free parameter file that would be generated using the -o syntax.
#'
#' @author Craig Marsh
#' @param file The name of the free parameter file containing model output to extract
