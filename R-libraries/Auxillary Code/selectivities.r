...
print("I haven't yet checked these functions are exact. I have just converted the C++ code to R code.")
...
## Logistic Producing
sel <- LogisticProducing(age_or_length = Age, a50 = 8, ato95 = 4, low = 4, high = 12)
plot(Age, sel, type = "l", xlim = c(1, 30), ylim = c(0, 1.05), main = "Logistic producing", yaxt = "s")
legend(X, Y, legend = c("a50 = 8", "ato95 = 4", "low = 4", "high = 12"), bty = "n")

## logisitic-capped alpha set to something other than 1
sel <- Logistic(age_or_length = Age, a50 = 13, ato95 = 3, alpha = 0.8)
plot(Age, sel, type = "l", xlim = c(1, 30), ylim = c(0, 1.05), main = "Logisitic-capped")
legend(X, Y, legend = c("a50 = 13", "ato95 = 3", "alpha = 0.8"), bty = "n")

## Double normal
sel <- DoubleNormal(age_or_length = Age, mu = 13, sigma_l = 3, sigma_r = 7)
plot(Age, sel, type = "l", xlim = c(1, 30), ylim = c(0, 1.05), main = "Double Normal", xaxt = "s", yaxt = "s")
legend(X, Y, legend = c("mu = 13", "sigma_l = 3", "sigma_r = 7"), bty = "n")
