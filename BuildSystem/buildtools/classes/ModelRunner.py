            ...
            if folder == "ORH3B":
                ...
                if not os.path.exists("sim/CPUEandes.1_01"):
                    print(
                        ...
                        + " -s run in "
                        + str(round(elapsed, 2))
                        + " expected simulated file sim/CPUEandes.1_01"
                    )
                    fail_count += 1
                if not os.path.exists("sim/CPUEandes.9_10"):
                    print(
                        ...
                        + " -s run in "
                        + str(round(elapsed, 2))
                        + " expected simulated file sim/CPUEandes.9_10"
                    )
                    fail_count += 1
                if not os.path.exists("sim/Obs_Andes_LF.3_05"):
                    print(
                        ...
                        + " -s run in "
                        + str(round(elapsed, 2))
                        + " expected simulated file sim/Obs_Andes_LF.3_05"
                    )
                    fail_count += 1
                os.chdir(cwd)
            else:
                if not os.path.exists("sim/sim_all_obs.1_01"):
                    print(
                        ...
                        + " -s run in "
                        + str(round(elapsed, 2))
                        + " expected simulated file sim/sim_all_obs.1_01"
                    )
                    fail_count += 1
                if not os.path.exists("sim/sim_all_obs.1_10"):
                    print(
                        ...
                        + " -s run in "
                        + str(round(elapsed, 2))
                        + " expected simulated file sim/sim_all_obs.1_10"
                    )
                    fail_count += 1
                os.chdir(cwd)
