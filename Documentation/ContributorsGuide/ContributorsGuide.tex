...
\newcommand{\ManualRef}{\authors\ (\DocYear). Contributors guide, \VER. \Organisation\ \emph{Technical Report}. \ref{TotPages} p. (Using source code from \SourceRepos)} % full document reference
...
% Title page
\pdfbookmark[1]{Contributors Guide}{title}
...
\begin{titlepage}
  \thispagestyle{empty} % no header/footer/page number on this page
	\begin{center}
		...
		\Large
		\vspace{1.0cm}
		Contributors Guide for use with \CNAME~(\VER) \\ \SourceRepos
...
\input{../UserManual/Appendix1_BuildEnvironment}
\clearpage{}

\input{../UserManual/Appendix2_BuildRules}
...
\input{../UserManual/Acknowledgments}
