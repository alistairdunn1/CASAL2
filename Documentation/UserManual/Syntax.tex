...
In the following section, the sub-section headers use a notation of the form "\textbf {@observation[label].type=abundance}" which, in this case, represents the following input command fragment
{\small{\begin{verbatim}
@observation label # where label is a unique label for that observation
type=abundance
...
...
The description of the observations is given in Section \ref{sec:Observation}. Each type of observation requires a set of subcommands and arguments specific to that process.
