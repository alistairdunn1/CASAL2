...
\usepackage[bookmarks=true,bookmarksopen=false,bookmarksnumbered=true,
    ...
    pdfsubject={Casal2 user manual for length-based models, Casal2 Steering Group Technical Report},
    pdftex]{hyperref}
\hypersetup{
...
\newcommand{\ManualRef}{\authors\ (\DocYear). \CNAME\ user manual for length-based models, \VER. \Organisation\ \emph{Technical Report}. \ref{TotPages} p. (Using source code from \SourceRepos)} % full document reference
