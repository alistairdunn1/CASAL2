...
\defSub{a}{The constant value (default a = 0) in ax^b + c}
\defType{Real number (estimable)}
\defDefault{0.0}
\defLowerBound{0.0 (inclusive)}

\defSub{b}{The constant value (default b = 0) in ax^b + c}
\defType{Real number (estimable)}
\defDefault{0.0}

\defSub{c}{The constant value (default c = 1) in ax^b + c}
\defType{Real number (estimable)}
\defDefault{1.0}
\defLowerBound{0.0 (inclusive)}

\defSub{beta}{The minimum age for which the selectivity applies}
\defType{Real number (estimable)}
\defDefault{0.0}
\defLowerBound{0.0 (inclusive)}
...
\subsubsection{Selectivity of type Multi\_Selectivity}
\commandlabsubarg{Selectivity}{type}{Multi\_Selectivity}.
\defRef{sec:Selectivity-MultiSelectivity}
\label{syntax:Selectivity-MultiSelectivity}
...
\defSub{default\_selectivity}{The selectivity used in missing years and the projections (if not otherwise specified)}
\defType{String}
\defDefault{No default}

\defSub{projection\_selectivity}{The selectivity used in missing projection years (defaults to the same selectivity label as 'default\_selectivity')}
\defType{String}
\defDefault{No default}
