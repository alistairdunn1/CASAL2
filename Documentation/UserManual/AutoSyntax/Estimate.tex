...
\defSub{cv}{The normal variance (standard deviation) parameter}
\defType{Real number (estimable)}
\defDefault{No default}
\defLowerBound{0.0 (exclusive)}
...
\subsubsection{Estimate of type Students\_t}
\commandlabsubarg{Estimate}{type}{Students\_t}.
\defRef{sec:Estimate-Studentst}
\label{syntax:Estimate-Studentst}

\defSub{mu}{The Student's t location (mu) parameter}
\defType{Real number (estimable)}
\defDefault{No default}
