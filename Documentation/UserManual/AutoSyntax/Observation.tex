...
\defSub{age\_weight\_labels}{The labels for the age\_weight block which corresponds to each category, to use the weight calculation method for biomass calculations}
\defType{Vector of strings}
\defDefault{No default}
...
\defSub{overlap\_scalar}{Scalar for the relative overlap of the tag recaptures}
\defType{Vector of real numbers (estimable)}
\defDefault{1.0}
\defLowerBound{0.0 (inclusive)}
