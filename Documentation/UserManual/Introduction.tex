...
The \CNAME\ user manual is available as two separate manuals; one for the age-based functionality and one for the length-based functionality. These two manuals contain many common components but there are differences in the specific processes and observations. 
\ifAgeBased 
...
Copyright \copyright 2016-\SourceControlYearDoc, \href{https://casal2.github.io/}{\Organisation}. All rights reserved.

\subsection{\I{Where to get \CNAME }}

Casal2 is available on \href{https://github.com/Casal2}{GitHub}. There are installation packages available for Linux and Microsoft Windows. Release versions of the package includes the \CNAME\ binary, the \CNAME\ \R\ library, the \CNAME\ User Manual and associated documentation, example models, and other information. The installation packages for all versions of \CNAME\ can be downloaded at \url{https://github.com/Casal2/CASAL2/releases}.  

See \url{https://casal2.github.io/} for more information about \CNAME.
