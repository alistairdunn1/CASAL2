...
\subsubsection{Additional prior of type ar1}
\commandlabsubarg{additional\_prior}{type}{AR1}
\defRef{sec:AdditionalPrior-AR1}
\label{syntax:AdditionalPrior-AR1}
...
\subsubsection{Additional prior of type normal}
\commandlabsubarg{additional\_prior}{type}{Normal}
\defRef{sec:AdditionalPrior-Normal}
\label{syntax:AdditionalPrior-Normal}
