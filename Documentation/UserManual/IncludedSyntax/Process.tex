...
\defDefault{No default}
\defValue{Valid column names are: \argument{method}, \argument{category}, \argument{selectivity}, \argument{u\_max}, \argument{time\_step}, and \argument{penalty}; and optionally \argument{biomass}, \argument{u}, and \argument{age\_weight\_label}}
\defNote{See below for example}
\begin{verbatim}
	table method
