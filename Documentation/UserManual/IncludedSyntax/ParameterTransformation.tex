...
\subsubsection{Parameter transformation of type difference}
\commandlabsubarg{parameter\_transformation}{type}{difference\_parameter}
\label{syntax:Transformation-Difference} \\~\\
The addressable parameter for this transformation is \subcommand{difference\_parameter}. See Section \ref{subsec:Transformation-types}, paragraph \ref{sec:Transformation-Difference}.
...
The addressable parameter for this transformation is \subcommand{sqrt\_parameter}. See Section \ref{subsec:Transformation-types}, paragraph \ref{sec:Transformation-Sqrt}.
