...
\defNote{To insert a process during initialisation, it needs to subscribe to the following format \subcommand{time\_step\_label()=process\_label}}
...
\subsubsection{Initialisation phase of type state category by age}
