...
\subsubsection{Ageing error of type data}
...
\defDefault{No default}
\defValue{An $n*n$ matrix, where $n=$ the number of ages in the model. See below for example} \hfill \vspace{-\baselineskip}
\begin{verbatim}
	table data 
	# example for a model with ages 1-3
	0.95 0.05 0.00
	0.05 0.90 0.05
	0.00 0.05 0.95
	end_table
...
\subsubsection{Ageing error of type off by one}
