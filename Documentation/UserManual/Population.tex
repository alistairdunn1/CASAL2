...
In addition, a derived quantity (e.g., \texttt{biomass\_index}) can have random error, autocorrelation, and bias added (however, these should never be used as quantities for determining recruitment or other parameters in estimation or MCMCs).\label{sec:DerivedQuantity-BiomassIndex}
