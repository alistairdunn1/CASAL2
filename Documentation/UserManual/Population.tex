...
\paragraph[Constant]{Constant:} The constant projection type \argument{constant} \index{Projections!Constant}\label{sec:Project-Constant}
...
\paragraph[Multiple Values]{Multiple Values:} The multiple values projection type \argument{multiple\_values} \index{Projections!Multiple Values}\label{sec:Project-MultipleValues}
...
\paragraph[Empirical sampling]{Empirical sampling:} Sampling from a range of years \argument{empirical\_sampling} \index{Projections!Empirical sampling}\label{sec:Project-EmpiricalSampling}
...
\paragraph[Lognormal]{Lognormal:} Sampling from a lognormal distribution \argument{lognormal} \index{Projections!Lognormal}\label{sec:Project-LogNormal}
...
\paragraph[Lognormal-Empirical]{Lognormal-Empirical:} Sampling from a lognormal distribution where the variance is estimated from values over a specified year range \argument{lognormal\_empirical} \index{Projections!Lognormal-Empirical}\label{sec:Project-LogNormalEmpirical} 
...
\paragraph[Catches]{Catches:} Specifying catch for projections \index{Projections!Catches}\label{sec:Project-Catch}
...
\paragraph[HarvestStrategyConstantCatch]{Harvest Strategy Constant Catch:} Specify catches for projections using a constant catch harvest strategy \argument{harvest\_strategy\_constant\_catch} \index{Projections!HarvestStrategyConstantCatch}\label{sec:Project-HarvestStrategyConstantCatch} 
...
\paragraph[HarvestStrategyConstantU]{Harvest Strategy Constant U:} Specify catches for projections using a constant $U$ harvest strategy \argument{harvest\_strategy\_constant\_u} \index{Projections!HarvestStrategyConstantU}\label{sec:Project-HarvestStrategyConstantU} 
