\section{\I{Troubleshooting}\label{sec:TroubleShooting}}
...
For most issues, \CNAME\ attempts to produce informative error messages. There are optional command line arguments that will give more verbose reporting, and should enable additional information to help resolve a problem. However, when \CNAME\ generates an error and the error message does not make sense, please let the Development Team know. Even if you manage to fix the problem yourself, we may be able to implement a more helpful error message or modify the user manual, and make life easier for the next person to encounter the problem. You can do this by submitting an issue on the GitHub repository at \url{https://github.com/Casal2/CASAL2/issues}.
...
If you find a bug or error in \CNAME, please submit an issue on the GitHub repository at \url{https://github.com/Casal2/CASAL2/issues}.
...
\subsection{Guidelines for reporting an error with \CNAME\label{sec:ErrorGuidelines}}
